  ...
  return (
    <div className="space-y-6">
      ...
      <div>
        ...
        <p className="text-muted-foreground mt-2">Configure a new LLM provider connection</p>
      </div>
      ...
      <form onSubmit={handleSubmit} className="border rounded-none p-6 space-y-6 max-w-2xl">
        ...
        <div className="flex gap-2 pt-2">
          ...
          <Button type="button" variant="outline" className="rounded-none" onClick={() => router.push("/admin/providers")}>
            Cancel
          </Button>
        </div>
      </form>
